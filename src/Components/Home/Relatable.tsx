...
const Relatable = () => {
  return (
    <section className="flex items-center mb-12 justify-center">
      <div className="grid max-w-6xl items-center gap-10 lg:grid-cols-2 lg:gap-14">
        <div className='text-evergreen-900 text-left'>
          <h2 className="font-extrabold tracking-tight text-3xl md:text-6xl sm:text-5xl">
            Built for real life
          </h2>
          ...
          <p className="mt-5 font-semibold leading-10 text-2xl ">
            ...
            <span className="relative font-extrabold mx-2 text-evergreen-600"> 30 minutes
              <span className="absolute inset-x-0 bottom-1 -z-10 rounded-sm bg-orange-500 h-4" />   </span>
