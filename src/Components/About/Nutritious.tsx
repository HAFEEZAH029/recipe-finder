...
const Nutritious = () => {
  ...
  return (
    <section className="mx-auto max-w-6xl mb-12 flex flex-col lg:flex-row lg:items-center items-start justify-between gap-8 lg:gap-0">
      <div className='w-full lg:w-[35%] text-left text-evergreen-900 space-y-5'>
        <h2 className="text-3xl mini:text-5xl lg:text-5xl font-extrabold">
          Beyond the plate
        </h2>
