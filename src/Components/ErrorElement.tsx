  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-6">
      <div className="text-center max-w-lg">
        ...
        <p className="text-lg text-evergreen-600 mb-8">
          {errorDetails}
        </p>

        <Link
          to="/"
          className="inline-block px-8 py-3 bg-evergreen-900 text-white font-semibold rounded-lg hover:bg-evergreen-700 transition"
        >
          Return Home
        </Link>
      </div>
